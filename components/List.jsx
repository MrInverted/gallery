  ...
  return (
    <div className="py-5 mt-5">
      ...
      <ul className="list-group">
        ...
        <li className="list-group-item">Загрузка и сохрание фотографии через formidable (Не работает на vercel)</li>
        ...
        <li className="list-group-item">Регистрация и авторизация через jwt и с выводом ошибки в форме (Не работает на vercel)</li>
